...
const stats = [
  { id: 1, name: "the property damage Pests produce annually in U.S.", value: "$5 billion" },
  { id: 2, name: "when home owners delay addressing pest control issues", value: " $2,500 more in repair costs " },
...
export default function ServiceSection2() {
  return (
    <div className="bg-gradient-to-b from-[#d3b5a9] to-[#d1aea1] -mt-8 lg:relative min-h-[700px] border-y  border-l-indigo-900 ">
      <div className="lg:absolute  left-0 right-0 lg:-top-10 mx-auto rounded-2xl bg-gray-900 max-w-6xl px-6 lg:px-20 py-24 sm:py-24">
