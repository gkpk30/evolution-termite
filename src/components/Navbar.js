  ...
  export default function Navbar() {
    ...
    return (
        ...
        <div className="mx-auto max-w-7xl">
          <div className="px-6 pt-4 pb-4 lg:mt-6 lg:max-w-2xl lg:pl-8 lg:pr-0 lg:bg-gray-800/70 rounded-bl-xl">
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-50 hover:bg-gray-100"
                    >
                      {item.name}
                    </a>
                  ))}
