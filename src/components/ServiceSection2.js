...
export default function ServiceSection2() {
  return (
    <div className="bg-gray-800 -mt-8 lg:relative min-h-[700px] ">
      <div className="lg:absolute  left-0 right-0 lg:-top-10 mx-auto rounded-2xl bg-black max-w-6xl px-6 lg:px-20 py-24 sm:py-24">
